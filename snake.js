...
let FOOD_SPEED = 5000; // Интервал между появлению еды.
let PROBLEM_SPEED = 5000; // Интервал между созданием препятствий.
...
let points = document.getElementsByClassName('score-point')[0]; // Показатель счета.
